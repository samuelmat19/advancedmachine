			...
			return this.each( function () {
				...
				cbtooltip.tooltip = cbtooltip.element.qtip({
					...
					show: {
						...
						solo: ( cbtooltip.settings.openSolo != null ? ( $( cbtooltip.settings.openSolo ).length ? $( cbtooltip.settings.openSolo ) : cbtooltip.settings.openSolo ) : ( tooltipModal ? $( document ) : false ) ),
