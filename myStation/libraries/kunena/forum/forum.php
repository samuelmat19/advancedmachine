...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		{
			self::$version = strtoupper('5.0.4.1');
		}

		self::$version_major = substr(self::$version, 0, 3);
		self::$version_date = ('2016-11-26' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2016-11-26';
		self::$version_name = ('Dhole' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Dhole';
	}
}
