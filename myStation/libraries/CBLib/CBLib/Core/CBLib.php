...
class CBLib
{
	protected static $THISCBVERSION		=	'2.0.15+build.2016.12.11.01.47.35.110148d3c';	 	// IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just above
	/**
	 * @var Application
	 */
